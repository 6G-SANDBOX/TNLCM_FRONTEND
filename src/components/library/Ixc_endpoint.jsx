...
const fetchData = async () => {
  ...
  if (access_token) {
    ...
    try {
      const response = await axios.get(`${url}/tnlcm/library/components/ixc_endpoint`, {
        headers: {
      ...
      alert(`Error fetching data for ixc_endpoint:`, error);
      return null;
    }
  }
  return null;
...
const IxcEndpoint = ({ id, removeComponent, onChange, list, whenError, defaultValues, name }) => {
