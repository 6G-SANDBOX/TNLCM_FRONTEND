...
const fetchData = async () => {
  ...
  if (access_token) {
    ...
    try {
      const response = await axios.get(`${url}/tnlcm/library/components/opensand_st`, {
        headers: {
      ...
      alert(`Error fetching data for opensand_st:`, error);
      return null;
    }
  }
  return null;
...
const OpensandSt = ({ id, removeComponent, onChange, list, whenError, defaultValues, name }) => {
